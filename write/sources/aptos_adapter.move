module nft_aggregator::aptos_adapter {
    ...
    use on_chain_nft_marketplace::listing::{Listing as AptosListing};
    use aptos_framework::fungible_asset::{Metadata};
    use on_chain_nft_marketplace::marketplace as on_chain_marketplace;
    ...
    public fun list_nft(
        ...
        let real_fee_schedule = object::address_to_object<on_chain_nft_marketplace::fee_schedule::FeeSchedule>(fee_schedule);
